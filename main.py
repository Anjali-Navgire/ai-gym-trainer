...
from services.persistence.excercise_repository import init_db, get_users_exercises
...
def main():
    ...
    with st.sidebar:
        ...
        if not workout_started:
            ...
            if start_session_button:
                ...
                st.session_state.play_workout_started = True
                st.rerun()
    ...
    if (
        st.session_state.get("audio_to_play") is not None
        and st.session_state.get("pending_audio", False)
    ):
    ...
    if not workout_started:
        ...
        if (
            st.session_state.get("play_workout_started", False)
        ...
        if st.session_state.voice_pipeline:
            metrics = {
                ...
                "back_angle": st.session_state.get("back_angle"),
